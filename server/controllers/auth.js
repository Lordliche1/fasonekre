...
const { burkinaLocations } = require('../burkina-faso-locations');
var nodemailer = require('nodemailer');
// const Blacklist  = require('../models/Blacklist')

const getLocations = async (req, res) => {
  res.status(StatusCodes.OK).json({ locations: burkinaLocations });
};
...
module.exports = { login, register, forgotPassword, resetPassword, getLocations }
